      ...
      *                                                                 00050148
       77 WS-BEGIN              PIC X(17) VALUE 'CIOH0026 WS BEGIN'.    00051048
       01 WS-VAR.
          05 WS-RESP-CODE       PIC S9(8) COMP.
          05 WS-OPTION          PIC 9(3).
          05 WS-CARD-NUMB       PIC 9(16).
      ...
      *SERVICE I/O
       ...
       COPY CIC0026O.
      *                                                                 00052048
       77 WS-END                PIC X(15) VALUE 'CIOH0026 WS END'.      00128048
      *
      ...
      *
       1000-INIT.
            INITIALIZE CIC0026I-REC
            MOVE CD-SRV-INPUT-DATA   TO CIC0026I-REC
            .
       1000-INIT-EXIT.
            EXIT.
      *
      ...
      *
       3000-MAIN-PROCESS.                                               00138048
            INITIALIZE CIC0026O-REC.
            EXEC CICS STARTBR
                 FILE('CIAULOG')
                 RIDFLD(CIC0026I-CARD-NUMB)
                 EQUAL
                 RESP(WS-RESP-CODE)
                 GENERIC
                 KEYLENGTH(16)
            ...
            EVALUATE (WS-RESP-CODE)
                WHEN DFHRESP(NORMAL)
                     ...
                     MOVE 'CARD-NB READED SUCCESSFULLY'
                                      TO CD-RESP-ADDITIONAL
                     MOVE CIC0026I-OPTION TO WS-OPTION
                     MOVE CIC0026I-CARD-NUMB TO WS-CARD-NUMB
                     INITIALIZE CIAUL-REC
                     EXEC CICS READNEXT
                            FILE('CIAULOG')
                            RIDFLD(WS-CARD-NUMB)
                            INTO(CIAUL-REC)
                     ...
                     PERFORM UNTIL WS-RESP-CODE = DFHRESP(ENDFILE)
                            OR CIAUL-CARD-NUMB NOT = CIC0026I-CARD-NUMB
                       ADD 1 TO CIC0026O-COUNT
                       MOVE CIAUL-CARD-NUMB TO
                                 CIC0026O-CARD-NUMB(CIC0026O-COUNT)
                       MOVE CIAUL-TIMESTAMP TO
                                 CIC0026O-TIMESTAMP(CIC0026O-COUNT)
                       MOVE CIAUL-AUTH-CODE TO
                                 CIC0026O-AUTH-CODE(CIC0026O-COUNT)
                       INITIALIZE CIAUL-REC
                       EXEC CICS READNEXT
                            FILE('CIAULOG')
                            RIDFLD(WS-CARD-NUMB)
                ...
                WHEN OTHER
                     ...
                     MOVE 'CARD NUMBER FILE READ FAILED'
                                 TO CD-RESP-ADDITIONAL
            END-EVALUATE
            .
      ...
      *
       5000-CLEAN-UP.
            MOVE CIC0026O-REC        TO CD-SRV-OUTPUT-DATA
