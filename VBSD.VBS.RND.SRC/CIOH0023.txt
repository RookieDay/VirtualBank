      ...
      *                                                                 00050148
       77 WS-BEGIN              PIC X(17) VALUE 'CIOH0023 WS BEGIN'.    00051048
       01 WS-VAR.
      ...
      *SERVICE I/O
       ...
       COPY CIC0023O.
      *                                                                 00052048
       77 WS-END                PIC X(15) VALUE 'CIOH0023 WS END'.      00128048
      *
      ...
      *
       1000-INIT.
            INITIALIZE CIC0023I-REC
            MOVE CD-SRV-INPUT-DATA   TO CIC0023I-REC
            .
       1000-INIT-EXIT.
            EXIT.
      *
      *
       2000-PRE-PROCESSING.
            ...
            MOVE CIC0023I-REC TO CIAUL-REC
            .
      *
       ...
       3000-MAIN-PROCESS.                                               00138048
            ...
            EVALUATE (WS-RESP-CODE)
                WHEN DFHRESP(NORMAL)
                     ...
                     MOVE 'CIAULOG ADDED SUCCESSFULLY'
                                 TO CD-RESP-ADDITIONAL
                     INITIALIZE CIC0023O-REC
                     MOVE CIAUL-REC TO CIC0023O-REC
                     INITIALIZE CD-SRV-OUTPUT-DATA
                     MOVE CIC0023O-REC TO CD-SRV-OUTPUT-DATA
                WHEN DFHRESP(DUPREC)
                     MOVE '1000' TO CD-RESP-CODE
                     MOVE 'CIAULOG EXISTED'
                                 TO CD-RESP-ADDITIONAL
                WHEN DFHRESP(NOTOPEN)
                     MOVE '2000' TO CD-RESP-CODE
                     MOVE 'CIAULOG FILE NOT OPEN'
                                 TO CD-RESP-ADDITIONAL
                WHEN DFHRESP(INVREQ)
                ...
                WHEN DFHRESP(FILENOTFOUND)
                     ...
                     MOVE 'CIAULOG FILE NOT FOUND'
                                 TO CD-RESP-ADDITIONAL
                WHEN OTHER
                     MOVE '9000' TO CD-RESP-CODE
                     MOVE 'CIAULOG ADDED FAILED'
                                 TO CD-RESP-ADDITIONAL
            END-EVALUATE
            .
