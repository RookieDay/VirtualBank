      ...
      *                                                                 00050148
       77 WS-BEGIN              PIC X(17) VALUE 'CIOH0007 WS BEGIN'.    00051048
       01 WS-VAR.
      ...
      *SERVICE I/O
       ...
       COPY CIC0007O.
      *                                                                 00052048
       77 WS-END                PIC X(15) VALUE 'CIOH0007 WS END'.      00128048
      *
      ...
      *
       1000-INIT.
            INITIALIZE CIC0007I-REC
            MOVE CD-SRV-INPUT-DATA   TO CIC0007I-REC
            .
       1000-INIT-EXIT.
            EXIT.
      *
       ...
       3000-MAIN-PROCESS.                                               00138048
            ...
            EVALUATE (WS-RESP-CODE)
                WHEN DFHRESP(NORMAL)
                     ...
                     INITIALIZE CIC0007O-REC
                     MOVE CIAPP-REC TO CIC0007O-REC
                     INITIALIZE CD-SRV-OUTPUT-DATA
                     MOVE  CIC0007O-REC TO CD-SRV-OUTPUT-DATA
                WHEN DFHRESP(NOTFND)
                     MOVE '1000' TO CD-RESP-CODE
                     MOVE 'APPLICATION NOT EXISTED'
                                 TO CD-RESP-ADDITIONAL
