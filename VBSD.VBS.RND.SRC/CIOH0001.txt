      ...
      *                                                                 00050148
       77 WS-BEGIN              PIC X(17) VALUE 'CIOH0001 WS BEGIN'.    00051048
       01 WS-VAR.
      ...
      *SERVICE I/O
       ...
       COPY CIC0001O.
      *                                                                 00052048
       77 WS-END                PIC X(15) VALUE 'CIOH0001 WS END'.      00128048
      *
      ...
      *
       1000-INIT.
            INITIALIZE CIC0001I-REC
            MOVE CD-SRV-INPUT-DATA   TO CIC0001I-REC
            .
       1000-INIT-EXIT.
            EXIT.
      *
      *
       2000-PRE-PROCESSING.
            ...
            MOVE CIC0001I-REC TO CICUS-REC
            .
      *
       ...
       3000-MAIN-PROCESS.                                               00138048
            ...
            EVALUATE (WS-RESP-CODE)
                WHEN DFHRESP(NORMAL)
                     ...
                     INITIALIZE CIC0001O-REC
                     MOVE CICUS-REC TO CIC0001O-REC
                     INITIALIZE CD-SRV-OUTPUT-DATA
                     MOVE CIC0001O-REC TO CD-SRV-OUTPUT-DATA
                WHEN DFHRESP(DUPREC)
