...
//SYSIN    DD *                                                         00050000
   ...
   IF MAXCC = 8 THEN SET MAXCC = 0                                      00080000
                                                                        00090000
   DEFINE CLUSTER(NAME(CLPS.VBS.RND.CI.OVS.CIACCT)         -            00100000
                      KEYS(16 0)                           -            00110000
                      TRACKS(10 10)                       -             00120000
                      VOLUME(OS39M1)                      -             00130000
                      RECSZ(150 150)                    -               00140000
                      FREESPACE(0 2)                      -             00150000
                      NOREUSE  SHR(2,3) SPEED)             -            00160000
                 DATA(NAME(CLPS.VBS.RND.CI.OVS.CIACCT.D)      -         00170000
                      CISZ(4096))                           -           00180000
                 INDEX(NAME(CLPS.VBS.RND.CI.OVS.CIACCT.I))              00190000
/*                                                                      00200000
